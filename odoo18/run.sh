...
# Usage: curl -s https://raw.githubusercontent.com/<your-repo>/odoo18/run.sh | sudo bash -s <instance_name> <ODOO_PORT> <LIVE_CHAT_PORT>
...
if [ "$#" -ne 3 ]; then
    ...
    echo "Example: $0 odoo-main 1018 2018"
    exit 1
fi
