#!/bin/bash
# Odoo 17 Deployment Script with Postgres Database and custom folder for Docker files
# Usage: curl -s https://raw.githubusercontent.com/webTronex/odoo-docker-compose/main/odoo17/run.sh | sudo bash -s <instance_name> <ODOO_PORT> <LIVE_CHAT_PORT> <docker_folder>
# Example: sudo bash run.sh odoo-main 1017 2017 my_odoo17_instance
